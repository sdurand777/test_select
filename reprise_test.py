...
parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default="./data/image_left/*.png")
parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default="./data/image_right/*.png")
...
if __name__ == '__main__':
    ...
    videoWrite = cv2.VideoWriter('./video_test.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 10, (514*3, 376))
    ...
    for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
        ...
        ht1, wd1, _ = image1.shape

        image_np = np.copy(image1)
        ...
        intrinsics_vec[0] *= wd1 / wd0
        intrinsics_vec[1] *= ht1 / ht0
        intrinsics_vec[2] *= wd1 / wd0
        intrinsics_vec[3] *= ht1 / ht0
        ...
        # fx, fy, cx1, cy = 320, 320, 320, 240
        # cx2 = 320

        fx, fy, cx1, cy = intrinsics_vec[0], intrinsics_vec[1], intrinsics_vec[2], intrinsics_vec[3]
        cx2 = intrinsics_vec[2]
